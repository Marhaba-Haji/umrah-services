...
const AdvancedPackageDetails = () => {
    ...
    itinerary: [
      {
        ...
        activities: [
          ...
          "Comfortable transfer to Makkah",
      ...
      {
        day: 2,
        location: "Makkah - First Umrah",
        activities: [
          "Early morning preparation",
          "First sacred Umrah",
          "Tawaf with guidance",
          "Sa'i completion ritual",
          "Rest & spiritual reflection",
          "Evening group prayers",
        ],
      },
      {
        day: 3,
        location: "Makkah - Spiritual Tours",
        activities: [
          "Additional blessed Tawaf",
          "Sacred Cave Hira visit",
          "Historical sites exploration",
          "Traditional shopping time",
      ...
      {
        day: 4,
        location: "Makkah - Mountain Tour",
        activities: [
          "Jabal Noor spiritual expedition",
          "Religious lectures by scholars",
          "Collective group prayers",
          "Free time for worship",
      ...
      {
        day: 5,
        location: "Makkah - Final Rituals",
        activities: [
          "Final blessed Umrah",
          "Farewell Tawaf ceremony",
          "Last-minute shopping",
          "Packing & preparation",
          "Group photo sessions",
          "Spiritual reflection time",
        ],
      },
      {
        day: 6,
        location: "Travel to Madinah",
        activities: [
          "Hotel checkout process",
          "Scenic Makkah to Madinah journey",
          "Welcome to Madinah arrival",
          "Hotel check-in ceremony",
          "First Masjid Nabawi visit",
          "Evening orientation session",
        ],
      },
      {
        day: 7,
        location: "Madinah - Sacred Visits",
        activities: [
          "Blessed Masjid Nabawi prayers",
          "Sacred Rawdah experience",
          "Comprehensive Ziarath tours",
          "Evening collective prayers",
      ...
      },
      {
        ...
        activities: [
          "Beautiful Quba Mosque visit",
          "Mount Uhud expedition",
          "Historical battlefields tour",
      ...
      {
        day: 9,
        location: "Madinah - Cultural Day",
        activities: [
          "Respectful Baqi cemetery visit",
          "Final Masjid Nabawi prayers",
          "Traditional shopping excursion",
          "Cultural heritage tours",
          "Photography sessions",
          "Farewell group activities",
        ],
      },
      {
        day: 10,
        location: "Madinah - Reflection",
        activities: [
          "Free morning for worship",
          "Final blessed Masjid Nabawi",
          "Farewell dinner ceremony",
          "Packing & preparation",
      ...
      {
        day: 11,
        location: "Departure Preparation",
        activities: [
          "Hotel checkout ceremony",
          "Airport transfer journey",
          "Flight departure process",
          "Journey home begins",
          "In-flight services",
          "Travel completion prayers",
        ],
      },
      {
        day: 12,
        location: "Safe Arrival",
        activities: [
          "Home country arrival",
          "Airport reception ceremony",
          "Journey completion celebration",
          "Cherished memories collection",
          "Spiritual fulfillment achieved",
    ...
    pricing: {
      group: {
        single: {
          adult: 89999,
          childWithBed: 67499,
          childWithoutBed: 44999,
          infant: 12000,
        },
        double: {
          adult: 69999,
          childWithBed: 52499,
          childWithoutBed: 34999,
          infant: 10000,
        },
        triple: {
          adult: 59999,
          childWithBed: 44999,
          childWithoutBed: 29999,
          infant: 8000,
        },
        quad: {
          adult: 54999,
          childWithBed: 41249,
          childWithoutBed: 27499,
          infant: 7000,
        },
        quint: {
          adult: 52999,
          childWithBed: 39749,
          childWithoutBed: 26499,
          infant: 6500,
        },
        six: {
          adult: 49999,
          childWithBed: 37499,
          childWithoutBed: 24999,
          infant: 6000,
        },
      },
      independent: {
        ...
        triple: {
          adult: 79999,
          childWithBed: 59999,
          childWithoutBed: 39999,
          infant: 10000,
        },
        quad: {
          adult: 74999,
          childWithBed: 56249,
          childWithoutBed: 37499,
          infant: 9000,
        },
        quint: {
          adult: 72999,
          childWithBed: 54749,
          childWithoutBed: 36499,
          infant: 8500,
        },
        six: {
          adult: 69999,
  ...
  const calculateTotalCost = () => {
    const roomPricing =
      packageData.pricing[packageType as keyof typeof packageData.pricing][
        selectedRoomType as keyof typeof packageData.pricing.group
      ];
    const cost =
                        ...
                        >
                          <div>
                            ...
                            <p className="text-sm text-gray-600">
                              Join with other pilgrims for a shared spiritual
                              journey
                            </p>
                          </div>
                        </Label>
                      ...
                      <div className="flex items-center space-x-2 p-4 border rounded-lg hover:bg-blue-50 transition-colors">
                        ...
                        >
                          <div>
                            ...
                            <p className="text-sm text-gray-600">
                              Private experience with personalized services
                            </p>
                          </div>
                        </Label>
                      </div>
                      ...
                      <div className="space-y-3">
                        <div>
                          ...
                          <p className="text-gray-600">
                            {packageData.flightDetails.departure} →{" "}
                            {packageData.flightDetails.arrival}
                          </p>
                        </div>
                        <div>
                          <span className="font-semibold text-gray-700">
                          ...
                          <p className="text-gray-600">
                            {packageData.flightDetails.airline}
                          </p>
                        </div>
                      </div>
                      <div className="space-y-3">
                        <div>
                          ...
                          <p className="text-gray-600">
                            {packageData.flightDetails.duration}
                          </p>
                        </div>
                        <div>
                          <span className="font-semibold text-gray-700">
                          ...
                          <p className="text-gray-600">
                            {packageData.flightDetails.type}
                          </p>
                        </div>
                      </div>
                      <div className="space-y-3">
                        <div>
                          ...
                          <p className="text-gray-600">
                            {packageData.flightDetails.aircraft}
                          </p>
                        </div>
                        <div>
                          <span className="font-semibold text-gray-700">
                          ...
                          <p className="text-gray-600">
                            {packageData.flightDetails.baggage}
                          </p>
                        </div>
                      </div>
                    </div>
                  ...
                  <CardContent>
                    <div className="bg-orange-50 p-4 rounded-lg mb-4">
                      <p className="text-gray-700 font-medium">
                        {packageData.mealPlan.description}
                      </p>
                    </div>
                    ...
                    <CardContent>
                      <div className="space-y-3">
                        {packageData.inclusions.map((item, index) => (
                          <div
                            key={index}
                            className="flex items-start space-x-2 p-2 hover:bg-emerald-50 rounded-lg transition-colors"
                          >
                    ...
                    <CardContent>
                      <div className="space-y-3">
                        {packageData.exclusions.map((item, index) => (
                          <div
                            key={index}
                            className="flex items-start space-x-2 p-2 hover:bg-red-50 rounded-lg transition-colors"
                          >
                    ...
                    <CardHeader>
                      <CardTitle className="flex items-center">
                        ...
                        Makkah Accommodation ({
                          packageData.makkahHotel.nights
                        }{" "}
                        nights)
                      </CardTitle>
                    </CardHeader>
                        ...
                        <div className="space-y-4">
                          <div>
                            ...
                            <div className="flex items-center mt-2">
                              ...
                              <span className="ml-2 text-sm text-gray-600 font-medium">
                                ({packageData.makkahHotel.rating}/5)
                              </span>
                            </div>
                          </div>
                          ...
                          <div>
                            ...
                            <div className="grid grid-cols-2 gap-2">
                              {packageData.makkahHotel.amenities.map(
                                (amenity, index) => (
                                  <Badge
                                    key={index}
                                    variant="outline"
                    ...
                    <CardHeader>
                      <CardTitle className="flex items-center">
                        ...
                        Madinah Accommodation ({
                          packageData.madinahHotel.nights
                        }{" "}
                        nights)
                      </CardTitle>
                    </CardHeader>
                        ...
                        <div className="space-y-4">
                          <div>
                            ...
                            <div className="flex items-center mt-2">
                              ...
                              <span className="ml-2 text-sm text-gray-600 font-medium">
                                ({packageData.madinahHotel.rating}/5)
                              </span>
                            </div>
                          </div>
                          ...
                          <div>
                            ...
                            <div className="grid grid-cols-2 gap-2">
                              {packageData.madinahHotel.amenities.map(
                                (amenity, index) => (
                                  <Badge
                                    key={index}
                                    variant="outline"
                      ...
                      {packageData.itinerary.map((day, index) => (
                        <div key={index} className="relative">
                          ...
                          {index < packageData.itinerary.length - 1 && (
                            <div className="absolute left-6 top-16 w-px h-12 bg-gradient-to-b from-emeral d-300 to-transparent"></div>
                          )}
                        </div>
                      ))}
                    </div>
                  ...
                  <CardContent>
                    <div className="grid md:grid-cols-2 gap-4">
                      {packageData.activities.map((activity, index) => (
                        <div
                          key={index}
                          className="flex items-start space-x-3 p-4 bg-gradient-to-r from-purple-50 to-indigo-50 rounded-lg hover:shadow-md transition-all duration-300 border border-purple-100"
                        >
                  ...
                  <Card>
                    ...
                    <CardContent>
                      <div className="space-y-6">
                        {Object.entries(
                          packageData.pricing[
                            packageType as keyof typeof packageData.pricing
                          ],
                        ).map(([roomType, prices]) => (
                          <div
                            key={roomType}
                            className="bg-gradient-to-r from-gray-50 to-blue-50 p-6 rounded-lg border"
                          >
                            <h4 className="font-bold text-xl mb-4 capitalize text-gray-900">
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                              ...
                              <div className="text-center p-4 bg-white rounded-lg shadow-sm">
                                ...
                                <p className="text-xl font-bold text-green-600">
                                  {convertPrice(prices.childWithBed)}
                                </p>
                                <p className="text-xs text-gray-500">
                                  per child
                                </p>
                              ...
                              <div className="text-center p-4 bg-white rounded-lg shadow-sm">
                                ...
                                <p className="text-xl font-bold text-orange-600">
                                  {convertPrice(prices.childWithoutBed)}
                                </p>
                                <p className="text-xs text-gray-500">
                                  per child
                                </p>
              ...
              <TabsContent value="terms" className="space-y-6">
                <div className="grid md:grid-cols-2 gap-6">
                  <Card>
                    ...
                    <CardContent className="space-y-3">
                      {packageData.terms.payment.map((term, index) => (
                        <div
                          key={index}
                          className="flex items-start space-x-2 p-2 hover:bg-green-50 rounded-lg transition-colors"
                        >
                  ...
                  <Card>
                    ...
                    <CardContent className="space-y-3">
                      {packageData.terms.responsibilities.map(
                        (responsibility, index) => (
                          <div
                            key={index}
                            className="flex items-start space-x-2 p-2 hover:bg-blue-50 rounded-lg transition-colors"
                          >
                  ...
                  <Card>
                    ...
                    <CardContent className="space-y-3">
                      {packageData.terms.disclaimers.map(
                        (disclaimer, index) => (
                          <div
                            key={index}
                            className="flex items-start space-x-2 p-2 hover:bg-yellow-50 rounded-lg transition-colors"
                          >
                    ...
                    <div className="flex items-center justify-between p-3 bg-green-50 rounded-lg">
                      ...
                      <div className="flex items-center space-x-3">
                        <Button
                          ...
                          variant="outline"
                          onClick={() =>
                            updateGuestCount("childWithBed", false)
                          }
                    ...
                    <div className="flex items-center justify-between p-3 bg-orange-50 rounded-lg">
                      ...
                      <div className="flex items-center space-x-3">
                        <Button
                          ...
                          variant="outline"
                          onClick={() =>
                            updateGuestCount("childWithoutBed", false)
                          }
                        ...
                        <Button
                          ...
                          variant="outline"
                          onClick={() =>
                            updateGuestCount("childWithoutBed", true)
                          }
                        >
                          <Plus className="w-3 h-3" />
                        </Button>
