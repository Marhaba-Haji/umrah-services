  ...
  const services = [
    {
      ...
      description: "Complete Umrah packages for groups with accommodation, transport, and guided tours",
      icon: Users,
    ...
    },
    {
      ...
      description: "Personalized Umrah packages tailored to your specific needs and preferences",
      icon: Package,
      route: "/umrah-packages",
    ...
    {
      title: "Umrah Visa",
      description: "Fast and reliable Umrah visa processing with expert assistance",
      icon: IdCard,
      route: "/apply",
    ...
    {
      title: "Group Flights",
      description: "Special group flight bookings for Umrah pilgrims with competitive rates",
      icon: Plane,
      route: "/group-flights",
    ...
    {
      title: "Hotel Booking",
      description: "Premium hotel accommodations near Haram with verified reviews",
      icon: Hotel,
      route: "/hotel",
    ...
    },
    {
      ...
      description: "Comfortable and reliable transport services throughout your journey",
      icon: Car,
      route: "/transport",
    ...
    },
    {
      ...
      description: "Guided visits to historical and religious sites in Makkah and Madinah",
      icon: Map,
      route: "/ziarath",
    ...
    {
      title: "Guide Booking",
      description: "Professional multilingual guides for your spiritual journey",
      icon: User,
      route: "/guide",
