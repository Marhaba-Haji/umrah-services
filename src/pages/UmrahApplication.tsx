  ...
  const renderStep2 = () => (
    <div className="space-y-6">
      ...
      <div className="grid md:grid-cols-2 gap-4">
        ...
        {dateError && (
          <div className="text-red-600 text-sm col-span-2">{dateError}</div>
        )}
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-2">
            Departure City *
          ...
          <Input
            ...
            onChange={(e) =>
              handleTravelerInputChange("departureCity", e.target.value)
            }
        ...
        <div>
          ...
          <Input
            ...
            onChange={(e) =>
              handleTravelerInputChange("hotelMakkah", e.target.value)
            }
        ...
        <div>
          ...
          <Input
            ...
            onChange={(e) =>
              handleTravelerInputChange("hotelMadinah", e.target.value)
            }
