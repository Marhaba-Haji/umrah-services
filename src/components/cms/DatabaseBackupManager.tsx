...
import { Download, Upload, Database, Clock, RefreshCw, Trash2, AlertTriangle } from 'lucide-react';
...
const DatabaseBackupManager = () => {
  ...
  const restoreBackup = async (backupId: string) => {
    try {
      const { data, error } = await supabase.functions.invoke('restore-database-backup', {
        body: { backupId }
      });
      ...
      <Card>
        ...
        <CardContent>
          <div className="flex flex-wrap gap-4 mb-6">
            ...
            >
              {backupInProgress ? <RefreshCw className="w-4 h-4 animate-spin" /> : <Database className="w-4 h-4" />}
              Full Backup
            </Button>
            <Button 
                            ...
                            <DialogContent>
                              <DialogHeader>
                                ...
                                <DialogDescription>
                                  ...
                                  Are you sure you want to restore from backup "{backup.backup_name}"? This action cannot be undone.
                                </DialogDescription>
                              </DialogHeader>
