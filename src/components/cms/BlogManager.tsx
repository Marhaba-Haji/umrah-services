...
interface BlogPost {
  ...
  speakable_schema?: unknown;
  faq_schema?: unknown;
  howto_schema?: unknown;
  local_business_schema?: unknown;
...
const BlogManager = () => {
      ...
      mainEntity: [
        {
          ...
          acceptedAnswer: {
            ...
            text: content
              ...
              : "Learn more about this topic in our comprehensive guide.",
          },
        },
      ],
    };
  ...
  const generateLocalBusinessSchema = () => {
    ...
    const localBusinessSchema = {
      ...
      name: title,
      description:
        form.getValues("meta_description") || "Local business information",
      address: {
        "@type": "PostalAddress",
  ...
  const onSubmit = async (data: unknown) => {
    try {
      ...
      const postData = {
        ...
        speakable_schema: data.speakable_schema
          ? JSON.parse(data.speakable_schema)
          : null,
        ...
        local_business_schema: data.local_business_schema
          ? JSON.parse(data.local_business_schema)
          : null,
        author_name: data.author_name || null,
        review_rating: data.review_rating
          ? parseFloat(data.review_rating)
          : null,
        video_url: data.video_url || null,
        image_gallery: data.image_gallery
          ? data.image_gallery.split(",").map((url) => url.trim())
          : null,
        related_searches: data.related_searches
          ? data.related_searches.split(",").map((keyword) => keyword.trim())
          : null,
  ...
  const handleEdit = (post: BlogPost) => {
    ...
    form.reset({
      ...
      speakable_schema: post.speakable_schema
        ? JSON.stringify(post.speakable_schema)
        : "",
      faq_schema: post.faq_schema ? JSON.stringify(post.faq_schema) : "",
      howto_schema: post.howto_schema ? JSON.stringify(post.howto_schema) : "",
      local_business_schema: post.local_business_schema
        ? JSON.stringify(post.local_business_schema)
        : "",
      author_name:
        post.author_name ||
      ...
      <div className="flex justify-between items-center">
        ...
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
          ...
          <DialogContent
            ...
            aria-describedby="blog-dialog-desc"
          >
            <DialogHeader>
              <DialogTitle>
              ...
              <DialogDescription id="blog-dialog-desc">
                Fill out the form to add or edit a blog post. All fields marked
                with * are required.
              </DialogDescription>
            </DialogHeader>
            <Form {...form}>
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Textarea
                              placeholder="Paste FAQPage JSON-LD here"
                              {...field}
                              rows={6}
                            />
                          </FormControl>
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Textarea
                              placeholder="Paste HowTo JSON-LD here"
                              {...field}
                              rows={6}
                            />
                          </FormControl>
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Textarea
                              placeholder="Paste LocalBusiness JSON-LD here"
                              {...field}
                              rows={6}
                            />
                          </FormControl>
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Textarea
                              placeholder="Paste Speakable JSON-LD here"
                              {...field}
                              rows={6}
                            />
                          </FormControl>
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input
                              placeholder="umrah tips, hajj guide, saudi travel"
                              {...field}
                            />
                          </FormControl>
                          <FormMessage />
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input
                              placeholder="umrah, hajj, saudi arabia"
                              {...field}
                            />
                          </FormControl>
                          <FormMessage />
