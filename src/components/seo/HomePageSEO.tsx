...
const HomePageSEO = () => {
  ...
  const organizationSchema = {
    ...
    description:
      "Leading Umrah visa processing and pilgrimage services provider with 97% approval rate. Complete Umrah packages, hotel booking, transport, and spiritual guidance for your sacred journey to Mecca and Medina.",
      ...
      itemListElement: [
        {
          ...
          itemOffered: {
            ...
            description:
              "Essential visa processing with standard approval timeline",
          },
        },
        {
          "@type": "Offer",
        ...
        },
        {
          ...
          itemOffered: {
            ...
            description:
              "Guaranteed fast-track processing in less than 24 hours",
          },
        },
      ],
    },
    ...
    review: [
      {
        ...
        reviewBody:
          "Excellent service for Umrah visa processing. Got my visa approved in just 3 days with all documentation support.",
      },
    ],
    sameAs: [
  ...
  const serviceSchema = {
    ...
    description:
      "Professional Umrah visa processing with guaranteed approval. Fast, secure, and hassle-free service for your sacred journey to Mecca and Medina.",
    provider: {
      "@type": "Organization",
      name: "Marhaba Haji",
    },
  ...
  return (
    <Helmet>
      ...
      <meta
        name="copyright"
        content={`© ${currentYear} Marhaba Haji. All rights reserved.`}
      />
      ...
      <meta
        ...
        content="Apply for Umrah visa online with 97% approval rate. Fast processing in 2-4 days, complete documentation support, and guaranteed approval. Start your sacred journey to Mecca & Medina with Marhaba Haji."
      />
      <meta
        property="og:image"
        content="https://rjyhoikoqhephrkjgebo.supabase.co/storage/v1/object/public/lovable-uploads//Marhaba%20Haji%20Logo%20ICon%20PNG.png"
      />
      <meta property="og:image:width" content="1200" />
      <meta property="og:image:height" content="630" />
      <meta
        property="og:image:alt"
        content="Marhaba Haji - Umrah Visa Processing Services"
      />
      ...
      <meta
        ...
        content="Apply for Umrah visa online with 97% approval rate. Fast processing in 2-4 days, complete documentation support, and guaranteed approval."
      />
      <meta
